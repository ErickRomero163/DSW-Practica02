...
- [ ] T005 [P] Implement HTTP Basic Authentication with environment-based credentials
- [ ] T006 [P] Setup API routing and middleware structure
- [ ] T007 Create base models/entities that all stories depend on
- [ ] T008 Configure error handling and logging infrastructure
- [ ] T009 Setup environment configuration management
- [ ] T010 [P] Confirm monorepo placement and workspace path conventions (backend/frontend)
- [ ] T011 [P] Add Docker runtime and local orchestration for app + PostgreSQL
- [ ] T012 [P] Enable OpenAPI generation and Swagger UI endpoint
- [ ] T013 [P] Add Angular 19 workspace/app setup tasks when frontend is in scope
